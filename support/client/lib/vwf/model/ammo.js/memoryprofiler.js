...
//    return '<span style="padding:0px; border:solid 1px black; width:32px;height:18px; display:inline-block;"><span style="display:inline-block; width:30px; height: 16px; background-color:'+color+'; margin: 1px;"></span></span>';
  ...
  var memoryStat = Module.getMemoryStats();



      STATIC_BASE = memoryStat.STATIC_BASE;
      STATICTOP = memoryStat.STATICTOP;
      STACK_BASE = memoryStat.STACK_BASE;
      STACKTOP = memoryStat.STACKTOP;
      STACK_MAX = memoryStat.STACK_MAX;
      DYNAMIC_BASE = memoryStat.DYNAMIC_BASE;
      DYNAMICTOP = memoryStat.DYNAMICTOP;
      TOTAL_MEMORY = memoryStat.TOTAL_MEMORY;
      TOTAL_STACK = memoryStat.TOTAL_STACK;
